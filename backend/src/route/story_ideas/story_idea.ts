...
import clearReaderState from "./story_idea/clear_reader_state.ts";
...
import setReaderState from "./story_idea/set_reader_state.ts";
...
export default new OpenAPIHono()
  ...
  .route("/", setReaderState)
  .route("/", clearReaderState);
