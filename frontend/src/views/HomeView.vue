 ...
 * rather than showing an empty page. The bars come from `App.vue`, which wraps every route.
 */
  ...
  <div class="flex-1 overflow-auto px-gutter py-5 pb-8 md:px-10">
    ...
    <div class="max-w-[60ch] border-t border-line-3 pt-6">
      <p class="text-body text-ink-4">
        Diese Seite ist noch in Arbeit. Was hier einmal steht, ist offen — bis dahin fängt alles in
        der Navigation an: bei deinen Gruppen liest und schreibst du weiter, bei den Storyideen
