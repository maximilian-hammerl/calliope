  ...
  <NarrowPage>
    ...
    <div v-else class="mt-7">
      <template v-if="deletionRequested">
        <p class="text-note text-ink-5">
          Wir haben einen Link an <span class="text-ink-2">{{ emailAddress }}</span> geschickt. Erst
          wenn du ihn öffnest, wird dein Konto gelöscht. Kommst du an diese Adresse nicht heran,
          ändere sie zuerst.
        </p>
