  ...
  >
    <ComboboxAnchor class="flex items-center gap-2">
      ...
      <ComboboxInput
        ...
        aria-label="Suche"
        placeholder="Suche"
        class="h-9 w-full rounded-md border border-input bg-transparent pr-3 pl-[30px] text-[13px] outline-none placeholder:text-ink-6 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
